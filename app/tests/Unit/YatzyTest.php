...
class YatzyTest extends TestCase
{
    ...
    public function setUp(): void
    {
        parent::setUp();
        $this->yatzy = new Game();
        $this->assertInstanceOf("\App\Classes\Yatzy\Game", $this->yatzy);
    }
    ...
    {
        $this->yatzy->playGame();
        $this->assertArrayHasKey("yatzySum", session()->all());
    }
    ...
    public function testSumRound()
    {
        ...
        $this->assertEquals(5, session("yatzySum"));
    }
