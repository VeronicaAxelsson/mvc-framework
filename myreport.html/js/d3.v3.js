!function () {
    ...
    function d3_timer(callback, delay, then)
    {
        ...
        if (d3_timer_queueTail) {
            d3_timer_queueTail.n = timer; } else {
    ...
    function d3_locale_timeFormat(locale)
    {
        ...
        function d3_time_format(template)
        {
            ...
            format.parse = function (string) {
                ...
                if ("j" in d) {
                    date.setFullYear(d.y, 0, d.j); } else if ("W" in d || "U" in d) {
                    if (!("w" in d)) {
                        d.w = "W" in d ? 1 : 0;
                    }
    ...
    d3.layout.tree = function () {
        ...
        function tree(d, i)
        {
            ...
            if (nodeSize) {
                d3_layout_hierarchyVisitBefore(root0, sizeNode); } else {
    ...
    d3.layout.treemap = function () {
        ...
        function treemap(d)
        {
            ...
            root.x = root.y = 0;
            if (root.value) {
                root.dx = size[0], root.dy = size[1]; } else {
                        root.dx = root.dy = 0;
                }
                if (stickies) {
    ...
    if (typeof define === "function" && define.amd) {
        this.d3 = d3, define(d3); } else if (typeof module === "object" && module.exports) {
        module.exports = d3; } else {
            this.d3 = d3;
        }
}();